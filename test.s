...
gloBal:
    ...
    pessoa1 : registroaluno := {idade = 20, peso = 80.2, nome = "Alguem"}
    pessoa2 : registroaluno := {idade = idademichely, peso = pesomichely, nome = nomemichely}
    pessoa3 : registroaluno := nulo
...
AÇÃO:
    ...
    notasdamichely[0,1] := 2.3/0.1;
    notasdamichely[1] := 5.2 - 2;
    notasdamichely[1+1] := 7.6;
    notasdamichely[6/2] := 4.9;
    
    se a & b verdadeiro 
        imprimemedia(regmichely.nome, notasdamichely)
    fse;
